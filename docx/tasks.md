...
- PXTK table (Get response from API 1.2): Example in docx/img/tongketcapxtk.png. The fields in the table and their value from the API response are:
  - Năng suất/h: round(sanluongca_qtksanxuatthucte/thongtincoban_thoigiansanxuat_gio)
  - Tổng SL ca: sanluongca_qtksanxuatthucte
  - TG chạy máy: thongtincoban_thoigiansanxuat_gio
  - Độ kiềm: null
  - FE gia quyền: 